...
void createDiff(istream& fold, istream& fnew, ostream& fdiff)
{
    ...
    for (int i = 0; i < newfile.size(); i++)
    {
        ...
        if (found == true)
        {
            ...
            int maxPos = pos[0];
            if (pos.size() > 100)     //helps with files like strange that don't have a lot of variability
            {
...
//    createDiff(o, p, n);
   assert(runtest("/Users/MurphyMadeleine17/Desktop/strange1.txt", "/Users/MurphyMadeleine17/Desktop/strange2.txt", "/Users/MurphyMadeleine17/Desktop/diff.txt", "/Users/MurphyMadeleine17/Desktop/new.txt"));
